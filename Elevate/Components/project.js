    ...
    return (
        <>
            ...
            >
                ...
                />
                <Text style={{ color: "black", fontSize: 10, paddingRight: 28, paddingTop: 15, position: "absolute", alignSelf: "flex-end" }}>{countlike >= 1000 ? countlike.valueOf(1) : countlike + 2000}</Text>
                <Pressable
